            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <?php
                    if(isset($_POST['createPatientProfile'])){
                        ...
                        registerPatient("getallpatients", $fName, $lName, $age, $gender, $phone, $email);
                    }
                ?>
                                ...
                                if($patients['success']){
                                    foreach($patients['data'] as $sub_array){
                                        ...
                                        <tr>
                                            ...
                                            <td class="row-data"><button type="button" class="btn btn-outline-primary btn-sm" style="--bs-btn-padding-y: 0rem; --bs-btn-padding-x: .25rem; --bs-btn-font-size: .75rem;">Edit</button></td>
                                            <td class="row-data"><button type="button" class="btn btn-outline-danger btn-sm" style="--bs-btn-padding-y: 0rem; --bs-btn-padding-x: .25rem; --bs-btn-font-size: .75rem;">Delete</button></td>
                                        </tr>
                                        ');
                                    }
                                }
                ...
                <div class="mb-5 shadow p-3">
                    ...
                    <form class="text-center" id="createPatientProfile" method="POST">
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="age" min="0" max="125" name="age" equired>
